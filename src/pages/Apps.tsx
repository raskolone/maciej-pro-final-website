      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
            {/* Left: Text Introduction (Boxed & Justified) */}
            <div className="lg:w-5/12 flex-shrink-0">
              ...
              >
                ...
                <div className="pt-2 border-l-2 border-primary/20 pl-5">
                  <p
                    className="text-foreground font-medium italic text-left"
            ...
            {/* Right: Apps Portfolio */}
            <div className="lg:w-7/12 w-full content-start">
              <style>{`
                @keyframes appCardPulse {
                  0%, 100% { box-shadow: 0 0 10px 1px oklch(0.65 0.2 145 / 0.05); }
                  50%       { box-shadow: 0 0 20px 2px oklch(0.65 0.2 145 / 0.15); }
                }
              `}</style>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-6">
                {apps.map((app) => (
                  <a
                    ...
                    className="group block border border-border hover:border-primary/50 transition-all duration-300 p-6 flex flex-col h-full"
                    style={{
                      borderRadius: "4px",
                      background: "oklch(0.13 0.015 240 / 0.6)",
                      animation: "appCardPulse 4s ease-in-out infinite",
                    }}
                  >
                    {/* Status badge */}
                    ...
                    {/* Description */}
                    <p className="text-sm text-muted-foreground leading-relaxed mb-6 flex-grow text-justify">
                      {t(app.descPl, app.descEn)}
                    </p>

                    {/* Link */}
                    <div className="flex items-center gap-2 text-xs text-primary/70 group-hover:text-primary transition-colors mt-auto pt-2 border-t border-border/50" style={{ fontFamily: "'DM Mono', monospace" }}>
